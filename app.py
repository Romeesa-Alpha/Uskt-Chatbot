...
def get_ai_response(messages, context, model):
    try:
        ...
        all_messages = [system_message]+ [system_message2]+ [system_message3]+ messages[:-1] + [{"role": "user", "Data": f"Context: {context}\n\n please answer the following question: {messages[-1]['content']}"}]
